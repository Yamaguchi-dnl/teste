...
const IMAGE_ID = "presentationVideo";
...
export default function AdminVideoPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: "Sucesso!",
        description: `Imagem do Vídeo de Apresentação atualizada.`,
      });
    ...
    <div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Atualize a imagem de fundo para a seção do vídeo de apresentação.</CardDescription>
        </CardHeader>
